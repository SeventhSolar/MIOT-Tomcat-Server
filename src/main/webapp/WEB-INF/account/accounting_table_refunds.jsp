  ...
  <table border=1 style="width:95%; max-width:900px;">
    <tr style="border:0;">
      <td style="border:0;" colspan=5>
        <h1 style="text-align:center; margin-bottom: 0; margin-bottom: 0;">Issued Refunds</h1>
      </td>
    </tr>
    <tr style="height:30px;">
      <th class=ctext>Family ID</th>
      <th class=ctext>Refunded</th>
    ...
    <c:forEach items="${ record_table }" var="row">
      <tr style="height:40px;">
        ...
        <td class=ctext><a:acc value="${ -1 * row.refunds }" /></td>
    ...
    <tr style="height:50px;">
      <td style="text-align:left">Total Refunded</td>
      <td class=ctext>${ -1 * total_refunds }</td>
    </tr>
  </table>
  ...
  <div style="flex-grow:1; margin-left:20px;">
    <form name="table_type" style="position:sticky; top:75px;">
      <select style="width:120px; overflow-y:auto" size="5">
        ...
        <option class="table_type" onclick="location.href='accounting_table_refunds';" selected>Refunds</option>
      </select>
    </form>
  </div>
</div>