  ...
  <table border=1 style="width:95%; max-width:900px;">
    <tr style="border:0;">
      <td style="border:0;" colspan=17>
        <h1 style="text-align:center; margin-bottom: 0; margin-bottom: 0;">Unpaid Accounts</h1>
      </td>
    </tr>
  ...
  <div style="flex-grow:1; margin-left:20px;">
    <form name="table_type" style="position:sticky; top:75px;">
      <select style="width:120px; overflow-y:auto" size="5">
        ...
        <option class="table_type" onclick="location.href='accounting_table_unpaid';" selected>Unpaid</option>
